        ...
        <Container maxWidth="lg" sx={{ py: 4 }}>
            ...
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="body1" paragraph>
                        All prices are in Indian Rupees (INR) and are subject to change without notice. Payment must be made at the time of order placement. We accept various payment methods as displayed during checkout.
                    </Typography>
                </Box>
