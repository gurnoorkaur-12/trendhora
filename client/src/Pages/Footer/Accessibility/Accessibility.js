    ...
    return (
        <div className="container">
            <h1>Accessibility Statement</h1>
                <p>
                    At Harmaig, we are committed to ensuring that our website is accessible to all users, regardless of ability.
                </p>
                <p>
                ...
                <p> <EmailIcon /> Email: <a href="mailto:support@harmaig.com" style={{color:"#444"}}>support@harmaig.com</a></p>
                <p> <LocalPhoneIcon /> Phone: +91-XXXXXXXXXX</p>
        </div>
    )
}
